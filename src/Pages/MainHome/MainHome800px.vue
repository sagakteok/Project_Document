            ...
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)" @click="GotoAllDocuments()">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">서류 하나하나 찾고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
          ...
          <v-hover v-slot="{isHovering, props}">
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">법률, 행정 업무를 처리하고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
          ...
          <v-hover v-slot="{isHovering, props}">
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">금융 및 세무 업무를 처리하고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
          ...
          <v-hover v-slot="{isHovering, props}">
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">자동차 관련 업무를 처리하고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
          ...
          <v-hover v-slot="{isHovering, props}">
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">부동산 관련 업무를 처리하고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
          ...
          <v-hover v-slot="{isHovering, props}">
            <v-card v-bind="props" elevation="0" :style="CardStyle(isHovering)">
              <v-list-item v-bind="props" :style="CardListitemStyle(isHovering)">
                ...
                <template v-slot:append>
                  <text style="font-weight: 500; font-size: 12px; color: #808080; margin-right: 10px">근로에 관한 업무를 처리하고 싶다면?</text>
                </template>
              </v-list-item>
            </v-card>
          </v-hover>
  ...
  methods: {
    ...
    CardTitleStyle(isHovering) {
      return {
        ...
        fontWeight: "800",
        fontSize: isHovering ? "16.5px" : "15px",
